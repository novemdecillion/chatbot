...
open class FlywaySchemaHistoryRecord() : UpdatableRecordImpl<FlywaySchemaHistoryRecord>(FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY), Record10<Int?, String?, String?, String?, String?, Int?, String?, LocalDateTime?, Int?, Boolean?>, IFlywaySchemaHistory {

    override var installedRank: Int?
    ...
    override var checksum: Int?
        set(value) = set(5, value)
        get() = get(5) as Int?

    override var installedBy: String?
        set(value) = set(6, value)
        get() = get(6) as String?

    override var installedOn: LocalDateTime?
        set(value) = set(7, value)
        get() = get(7) as LocalDateTime?

    override var executionTime: Int?
    ...
    override fun field1(): Field<Int?> = FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY.INSTALLED_RANK
    override fun field2(): Field<String?> = FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY.VERSION
    override fun field3(): Field<String?> = FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY.DESCRIPTION
    override fun field4(): Field<String?> = FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY.TYPE
    override fun field5(): Field<String?> = FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY.SCRIPT
    override fun field6(): Field<Int?> = FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY.CHECKSUM
    override fun field7(): Field<String?> = FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY.INSTALLED_BY
    override fun field8(): Field<LocalDateTime?> = FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY.INSTALLED_ON
    override fun field9(): Field<Int?> = FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY.EXECUTION_TIME
    override fun field10(): Field<Boolean?> = FlywaySchemaHistoryTable.FLYWAY_SCHEMA_HISTORY.SUCCESS
